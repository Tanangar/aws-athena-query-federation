...
public interface FederationRequestHandler extends RequestStreamHandler
{
    ...
    default SecretsManagerClient getSecretsManagerClient(AwsRequestOverrideConfiguration awsRequestOverrideConfiguration,
                                                         SecretsManagerClient defaultSecretsManager)
    {
        AwsCredentialsProvider awsCredentialsProvider = getAwsCredentialsProvider(awsRequestOverrideConfiguration);
